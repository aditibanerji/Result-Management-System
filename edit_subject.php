...
$sid=$_GET['subjectid'];
 ...
 if(isset($_POST['submit']))
 {
    ...
    $sql = "UPDATE subjects set subject_name = '$subjectname' , subject_id = '$subjectid' WHERE subject_id = '$sid' ";
...
<div class="container-fluid min-vh-100 d-flex justify-content-center align-items-center">  
                  ...
                  <div class="mb-6" id="m">
                        ...
                        <input type="text" class="form-control" id="subjectname" value="<?php echo htmlentities($row['subject_name']);?>"  name="subjectname"  >
                    </div>


                  <div class="mb-5 mt-5" id="m">
                         <label for="subid" class="form-label">Subject ID</label>
                         <input type="text" class="form-control" id="subid" value="<?php echo htmlentities($row['subject_id']);?>" name="subid">
