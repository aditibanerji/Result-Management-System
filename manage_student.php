...
<html lang="en">
    <head>
        ...
        <title>SRMS Manage Student</title>
...
<section class="section">
  ...
  <?php
   $sql = "SELECT student.student_name , student.roll_id , student.student_id ,classes.class_name ,classes.section FROM student join classes on student.class_id = classes.class_id";
   ...
   { 
        ...
        {?>
         ...
         <tr>
               ...
               <td> <a href="edit_student.php?studentid=<?php echo htmlentities($row['student_id']);?>"><i class="fa fa-edit" title="Edit Record"></i></a></td>
         </tr>
