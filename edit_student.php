...
$sid = intval($_GET['studentid']);
 ...
 if(isset($_POST['submit']))
 {
    ...
    $sql = "UPDATE student SET student_name = '$studentname' , roll_id = '$rollid' WHERE student_id = '$sid' ";
    
    if(mysqli_query($conn,$sql))
    {
        $msg = "Student Detail Updated Successfully";
    }
    else
    {
...
<section class="section">
    ...
    <div class="container-fluid">
        <div class="row">
          ...
          $sql= "SELECT student.student_name , student.roll_id , student.student_id, classes.class_name , classes.section from student join classes on classes.class_id = student.class_id WHERE student.student_id = '$sid'";
...
<div class="container-fluid min-vh-100 d-flex justify-content-center align-items-center">  
                   ...
                   <div class="mb-6" id="m">
                        ...
                        <input type="text" class="form-control" id="name" value="<?php echo htmlentities($row['student_name']);?>" name="name">
                    </div>


                    <div class="mb-5 mt-5" id="m">
                         <label for="rollid" class="form-label">Roll ID</label>
                         <input type="text" class="form-control" id="rollid" value="<?php echo htmlentities($row['roll_id']);?>" name="rollid">
                  ...
                  <div class="mb-5 mt-5" id="m">
                         ...
                         <input type="text" class="form-control" id="studentid" value="<?php echo htmlentities($row['student_id']);?>" name="studentid">
                           
                  </div>

                  <div class="mb-5 mt-5" id="m">
                         <label for="classid" class="form-label">Class</label>
                         <input type="text" class="form-control" id="classid" value="<?php echo htmlentities($row['class_name']);?>( <?php echo htmlentities($row['section'])?>)" name="classid" readonly>
