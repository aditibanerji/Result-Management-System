...
$error=null;
 ...
 if(isset($_POST['submit']))
 {
    ...
    $sql = "INSERT INTO subjects(subject_id , subject_name ) VALUES ('$subjectid' ,'$subjectname')";
...
<html lang="en">
    <head>
        ...
        <title>SRMS Create Subject</title>
            ...
            <div class="col-md-8 col-md-offset-2">
                 ...
                 <div class="container-fluid min-vh-100 d-flex justify-content-center align-items-center">  
                  ...
                  <div class="mb-5 mt-5" id="m">
                         ...
                         <input type="text" class="form-control" id="subid" placeholder="Enter SubjectID" name="subid">
