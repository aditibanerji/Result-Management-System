...
$error=null;
 ...
 if(isset($_POST['submit']))
 {
    ...
    $sql = "INSERT INTO subjects_combination( class_id , subject_id) VALUES ('$class' ,'$subject')";
...
<html lang="en">
    <head>
        ...
        <title>SRMS Create Subject Combination</title>
            ...
            <div class="col-md-8 col-md-offset-2">
                 ...
                 <?php
                  ...
                  <div class="alert alert-success left-icon-alert" role="alert">
                    <strong> Subject Combination Created</strong>
                 ...
                 <div class="container-fluid min-vh-100 d-flex justify-content-center align-items-center">  
                   <form action="create_subjectcomb.php" method="POST">
...
<?php 
$sql = "SELECT * from classes ORDER BY class_name DESC";
...
if(mysqli_num_rows($result)>0) 
{
    ...
    { ?>
      ...
      <option value="<?php echo htmlentities($row['subject_id']);?>"><?php echo htmlentities($row['subject_name']);?> &nbsp; - <?php echo htmlentities($row['subject_id']);?></option>
