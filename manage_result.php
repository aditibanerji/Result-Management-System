...
<html lang="en">
    <head>
        ...
        <title>SRMS Manage Result</title>
...
<section class="section">
  ...
  <?php
   $sql = "SELECT distinct student.student_name , student.roll_id ,student.student_id , classes.class_name, classes.section FROM result join student on student.student_id=result.student_id join classes on classes.class_id = result.class_id ORDER BY classes.class_name DESC, classes.section";
   ...
   { 
        ...
        {?>
         ...
         <tr>
               ...
               <td><?php echo htmlentities($row['roll_id']);?></td>
               <td><?php echo htmlentities($row['class_name']);?> &nbsp;- <?php echo htmlentities($row['section']);?></td>
               <td> <a href="edit_result.php?stid=<?php echo htmlentities($row['student_id']);?>"><i class="fa fa-edit" title="Edit Record"></i></a></td>
         </tr>
