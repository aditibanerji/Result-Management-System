...
if(isset($_GET['did']))
{
    ...
    $sql = "DELETE from subjects_combination WHERE id = '$did'";
...
<section class="section">
  ...
  <?php
   $sql = "SELECT classes.class_name , classes.section , subjects.subject_name , subjects_combination.id as scid from subjects_combination join classes on classes.class_id = subjects_combination.class_id join subjects on subjects.subject_id = subjects_combination.subject_id";
        ...
        {?>
         ...
         <tr>
              ...
              <td><?php echo htmlentities($row['subject_name']);?></td>
               <td> <a href="manage_subjectcomb.php?did=<?php echo htmlentities($row['scid']);?>" onclick="confirm('do you want to deactivate subject ?')"><i class="fa fa-edit" title="Deactivate Subject "></i></a></td>
         </tr>
