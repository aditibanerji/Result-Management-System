...
$error=null;
 ...
 if(isset($_POST['submit']))
 {
   $currentpw = $_POST['cp'];
    ...
    if($newpw===$confirmpw)
    {
               $sql = "UPDATE admin set password ='$confirmpw'";
    ...
    {
        $error="New password and Confirm Password Donot match";
    }
...
<div class="container-fluid min-vh-100 d-flex justify-content-center align-items-center">  
                  ...
                  <div class="mb-6" id="m">
                        ...
                        <input type="password" class="form-control" id="classname" placeholder="Enter current password"  name="cp" required="required"  >
                    </div>


                  <div class="mb-5 mt-5" id="m">
                         <label for="np" class="form-label">New Password</label>
                         <input type="password" class="form-control" id="np" placeholder="Enter new password" name="np">
                  ...
                  <div class="mb-5 mt-5" id="m">
                         ...
                         <input type="password" class="form-control" id="confirmpw" placeholder="Enter confirm password" name="confirmpw">
