...
$cid = $_GET['classid'];
 ...
 if(isset($_POST['submit']))
 {
    ...
    $sql = "UPDATE classes set class_name = '$classname' , section='$section' , class_id = '$classid' WHERE class_id = '$cid' ";
...
<section class="section">
    ...
    <div class="container-fluid">
        <div class="row">
          ...
          $sql= "SELECT * from classes where class_id = '$cid'";
...
<div class="container-fluid min-vh-100 d-flex justify-content-center align-items-center">  
                  ...
                  <div class="mb-6" id="m">
                        ...
                        <input type="text" class="form-control" id="classname" value="<?php echo htmlentities($row['class_name']);?>"  name="classname"  >
                    </div>


                  <div class="mb-5 mt-5" id="m">
                         <label for="sec" class="form-label">Section</label>
                         <input type="text" class="form-control" id="sec" value="<?php echo htmlentities($row['section']);?>" name="sec">
                  ...
                  <div class="mb-5 mt-5" id="m">
                         ...
                         <input type="text" class="form-control" id="classid" value="<?php echo htmlentities($row['class_id']);?>" name="classid">
